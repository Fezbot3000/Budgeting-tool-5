...
function updateMonthlyAccordion(chartData) {
    ...
    chartData.dates.forEach((monthYear, index) => {
            ...
            <div class="cycle-summary cycle-${index}">
                <div class="cycle-info">
                    <span class="right-align ss">${monthYear}</span>
                </div>
                <div class="income-summary">
                    <div class="box1">
                        <div class="img-container">
...
function openIncomeModal(vl=0) {
    ...
    if(vl==2)
    {
        document.getElementById('nxtsp').innerText = 'Save';
    }
    else
    {
        document.getElementById('nxtsp').innerText = 'Next Step';
    }
    document.getElementById('incomeModal').style.display = 'block';
}

function openIncomeModal2() {
    document.getElementById('editFrequency2').value = payFrequency;
    document.getElementById('editIncome2').value = income;
    document.getElementById('editPayday2').valueAsDate = new Date();
    document.getElementById('incomeModal2').style.display = 'block';
}
...
function updateIncome2() {
    payFrequency = document.getElementById('editFrequency2').value;
    income = parseFloat(document.getElementById('editIncome2').value);
    payday = document.getElementById('editPayday2').value;
    saveToLocalStorage();
...
function handleScreenChange(e) {
    ...
    if (e.matches) {
        ...
        if (window.location.href === pcURL) {
            window.location.href = baseURL; // Redirect to base URL
        }
    } else {
        
        if (window.location.href !== pcURL) {
            window.location.href = pcURL; // Redirect to PC URL
        }
    }
}
